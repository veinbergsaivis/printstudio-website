  ...
  return (
    ...
    >
      ...
      <div className='relative flex-grow mb-4'>
        <span className='absolute -top-2 -left-3 text-6xl text-primary/20 font-serif select-none opacity-80'>
          “
        </span>
        <p className='text-text-muted leading-relaxed italic'>
          {t(testimonial.testimonialTextKey, 'Atsauksmes teksts šeit...')}
        </p>
        <span className='absolute -bottom-5 -right-1 text-6xl text-primary/20 font-serif select-none opacity-80 transform scale-x-[-1]'>
          ”
        </span>
      </div>
