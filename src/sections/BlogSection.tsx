...
const BlogSection: React.FC = () => {
  ...
  return (
    // Fons - surface (balts), Teksts - text-base
    <section id='blog' className='relative py-16 md:py-24 bg-surface text-text-base'>
      ...
      {/* White fade overlay apakšā - pāreja uz bg-accent/10 */}
      <div
      ...
      <div className='container mx-auto px-4 md:px-8 relative z-[2]'>
        <div className='text-center mb-10 md:mb-16'>
          ...
          <p className='text-lg text-text-muted max-w-2xl mx-auto'>
            ...
            {t(
              'blog.description',
              'Izpētiet mūsu jaunākos rakstus, ieskatus un tendences drukas nozarē'
            )}
          </p>
        </div>
        ...
        {blogPosts.length > previewPosts.length && (
          <div className='text-center mt-10 md:mt-16'>
            ...
            >
              {/* Pievienojam noklusējuma vērtību */}
              {t('blog.showAll', 'Rādīt visus ierakstus')}{' '}
              {/* Izmantojam 'blog.showAll' atslēgu no i18n */}
            </Button>
          </div>
        )}
      </div>
